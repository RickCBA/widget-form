    ...
    cannedMsgDiv.innerHTML = `
            <div style="position: relative;">
              ...
              <div class="canned-messages-grid">
                <button data-message="Book an Appointment" data-send="Hello, I’d like to book an appointment.">Book an Appointment</button>
                <button data-message="Emergency Appointment" data-send="I’m experiencing a dental emergency and need to be seen soon. Can someone contact me urgently">Emergency Appointment</button>
                <button data-message="Dental Check-up & Cleaning" data-send="Hi, I’d like a routine dental check-up and cleaning.">Dental Check-up & Cleaning</button>
                <button data-message="Straighten My Teeth" data-send="I’m interested in straighter teeth and a better smile.">Straighten My Teeth</button>
                <button data-message="Replace Missing Teeth" data-send="Hi, I need to replace a missing tooth (or teeth).">Replace Missing Teeth</button>
                <button data-message="Teeth Whitening & Cosmetic Treatments" data-send="Hello, I’m looking for teeth whitening or cosmetic dentistry options. Let's discuss my goals">Teeth Whitening & Cosmetic Treatments</button>
